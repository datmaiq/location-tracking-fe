            ...
            {others?.length > 0
              ? others?.map((user) => (
                  <div
                    key={user?._id}
                    id={`friend-${user?._id}`}
                    className="group h-48 w-full  relative z-10 rounded-2xl shadow-lg dark:shadow-black bg-[#f6f6f9]rounded-2xl dark:bg-indigo-600 transition-all duration-1000"
                  >
