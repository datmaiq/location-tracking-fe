    ...
    <div className="relative h-screen overflow-hidden">
      <div className="w-screen fixed flex bg-transparent flex-col items-center justify-center top-1/3 text-white z-50">
        <div className="flex flex-col justify-center items-center w-full p-2 lg:p-0 lg:w-[500px]">
          ...
          <Link to="/signin" className="bg-primary-500 w-fit text-white mt-4 p-2 border-[1px] rounded hover:border-primary-500 hover:shadow transition-all duration-200 no-underline hover:no-underline">Get Started!</Link>
        </div>
      </div>
