      ...
      <div className="flex justify-center items-center">
        <form onSubmit={handleSignin} className="w-full mx-5 lg:mx-0 sm:w-[300px] flex flex-col space-y-5 ">
          ...
          </div>
          {
            loading
              ? <ButtonLoader />
              : <button type="submit" className="bg-primary-500 w-full text-white p-2 border-[1px] border-border_color rounded hover:border-primary-500  hover:shadow transition-all duration-200">Login</button>
